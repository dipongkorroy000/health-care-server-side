...
const create = zod_1.z.object({
    body: zod_1.z.object({
        ...
        experience: zod_1.z.number({ error: "Experience is required" }),
        gender: zod_1.z.string({ error: "Gender is required" }),
        appointmentFee: zod_1.z.number({ error: "Appointment Fee is required" }),
        qualification: zod_1.z.string({ error: "Qualification is required" }),
        currentWorkingPlace: zod_1.z.string({ error: "Current Working Place is required" }),
        designation: zod_1.z.string({ error: "Designation is required" }),
    }),
});
...
exports.DoctorValidation = { create, update };
