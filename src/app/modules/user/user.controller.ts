...
const updateMyProfile = catchAsync(async (req: Request & {user?: IJWTPayload}, res: Response) => {
  const result = await UserService.updateMyProfile(req.user as IJWTPayload, req.body, req.file);
...
export const UserController = {createPatient, getAllUser, createDoctor, createAdmin, getMyProfile, changeProfileStatus, updateMyProfile};
